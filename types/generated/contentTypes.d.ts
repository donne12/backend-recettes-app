...
export interface ApiCategorieCategorie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    recette: Schema.Attribute.Relation<'oneToOne', 'api::recette.recette'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nom: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    quantite: Schema.Attribute.String;
    recettes: Schema.Attribute.Relation<'manyToMany', 'api::recette.recette'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiRecetteRecette extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    etapes: Schema.Attribute.RichText;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    temps_cuisson: Schema.Attribute.Integer;
    temps_preparation: Schema.Attribute.Integer;
